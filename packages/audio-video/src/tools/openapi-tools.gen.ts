        ...
        requestBody: {
          ...
          properties: {
                  ...
                  variables: {
                    ...
                    items: {
                      ...
                      properties: {
                        ...
                        scale: {
                          type: 'string',
                          enum: ['no_scale', 'fit_to_frame', 'stretch_to_fill', 'fill_frame'],
            ...
            outputs: {
              ...
              items: {
                type: 'object',
                required: ['variationIndex', 'presetIndex'],
                properties: {
                  variationIndex: {
                    type: 'number',
              ...
              items: {
                ...
                properties: {
                  ...
                  position: {
                    ...
                    required: ['anchorPoint', 'offsetX', 'offsetY'],
                ...
                required: ['mediaType', 'source', 'startTime', 'duration', 'scale', 'position'],
              ...
              properties: {
                ...
                focalPoints: {
                  ...
                  items: {
                    ...
                    description:
                      'Focal point keyword to utilize Semantic Subject Lock. Must be alphanumeric characters, spaces, hyphens, or underscores only. Maximum 1000 characters per keyword.',
                  },
                  maxItems: 10,
                  description:
                    ...
                    properties: {
                      ...
                      repeat: {
                        oneOf: [
                          ...
                          {
                            type: 'string',
                            enum: ['stop_on_last_frame', 'loop', 'time_stretch'],
                      ...
                      oneOf: [
                        {
                          ...
                          properties: {
                            color: {
                              ...
                              pattern: '^#[0-9a-fA-F]{6}$',
                              description:
                                'Color code for the background of the output. This should be a six digit hexadecimal value.',
                            },
                          },
                        },
                        {
