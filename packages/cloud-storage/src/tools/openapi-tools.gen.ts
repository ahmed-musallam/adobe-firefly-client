                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      role: {
                        ...
                        enum: ['edit', 'comment', 'undefined'],
                      },
                    },
                    required: ['recipient', 'type', 'role'],
                  },
                  maxItems: 10,
                  default: [],
                },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        requestBody: {
          ...
          required: ['size', 'parentId', 'name', 'mediaType'],
        },
      },
      required: ['requestBody'],
    },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        requestBody: {
          ...
          required: ['uploadId', 'usedTransferLinks'],
        },
      },
      required: ['requestBody'],
    },
