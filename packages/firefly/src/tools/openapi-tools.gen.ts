...
export const openapiMcpTools = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      required: ['x-model-version', 'requestBody'],
    },
    method: 'post',
    ...
    inputSchema: {
      ...
      properties: {
        'x-model-version': {
          type: 'string',
          default: 'image3',
          enum: ['image3', 'image4_standard', 'image4_ultra'],
  ...
  },
  {
    ...
    inputSchema: {
          ...
          properties: {
            ...
            output: {
              ...
              properties: {
                mediaType: {
                  type: 'string',
                  enum: ['image/png', 'image/jpeg', 'image/webp', 'image/jxl'],
      ...
      required: ['content-type', 'requestBody'],
    },
    method: 'post',
