        ...
        requestBody: {
          ...
          properties: {
            $schema: {
              ...
              type: 'string',
              format: 'uri',
              examples: ['https://s3d.adobe.io/schemas/restv1.ComposeSceneRequest.json'],
            },
            cameraName: {
              description:
            ...
            modelVersion: {
              ...
              enum: ['image3_fast', 'image4_standard', 'image4_ultra'],
            },
            numVariations: {
              description:
                    ...
                    transform: {
                      ...
                      properties: {
                        azimuthAltitude: {
                          ...
                          additionalProperties: false,
                          required: ['azimuth', 'altitude', 'lookAt', 'radius'],
                        },
                        matrix: {
                          description:
              ...
              items: {
                ...
                properties: {
                  ...
                  'next.frame.io': {
                    ...
                    additionalProperties: false,
                    required: ['folderId', 'accountId', 'accessToken'],
                  },
                  space: {
                    description:
                  ...
                  url: {
                    ...
                    properties: {
                      ...
                      url: {
                        ...
                        type: 'string',
                        examples: ['https://cdn.substance3d.com/v2/files/public/stepladder.usdz'],
                      },
                    },
                    additionalProperties: false,
                    required: ['url'],
          ...
          examples: [
            {
              ...
              heroAsset: 'bottle',
              prompt:
                'french style kitchen with empty wooden table window on the left focal length 50mm',
              sources: [
                {
                  url: {
          ...
          required: ['sources', 'prompt', 'heroAsset'],
        ...
        requestBody: {
          ...
          properties: {
            $schema: {
              ...
              type: 'string',
              format: 'uri',
              examples: ['https://s3d.adobe.io/schemas/restv1beta.CreateSceneRequest.json'],
            },
            encoding: {
              description: 'Encoding output format.',
              type: 'string',
              enum: ['glb', 'gltf', 'fbx', 'usdz', 'usda', 'usdc', 'obj'],
            },
            fileBaseName: {
              ...
              properties: {
                ...
                materials: {
                  ...
                  items: {
                    ...
                    additionalProperties: false,
                    required: ['materialName', 'material', 'nodeList'],
                  },
                },
                metersPerUnit: {
                  description:
                                ...
                                properties: {
                                  variants: {
                                    ...
                                    items: {
                                      ...
                                      additionalProperties: false,
                                      required: ['primName', 'variantSet', 'variant'],
                                    },
                                  },
                                },
                                additionalProperties: false,
          ...
          required: ['scene', 'sources', 'encoding', 'fileBaseName'],
          description: 'The JSON request body.',
        },
      },
    },
        ...
        requestBody: {
          ...
          properties: {
            $schema: {
              ...
              type: 'string',
              format: 'uri',
              examples: ['https://s3d.adobe.io/schemas/restv1beta.ModelConvertRequest.json'],
            },
            format: {
        ...
        requestBody: {
          ...
          properties: {
            $schema: {
              ...
              type: 'string',
              format: 'uri',
              examples: ['https://s3d.adobe.io/schemas/restv1beta.SceneDescRequest.json'],
            },
            sceneFile: {
              description:
        ...
        requestBody: {
          ...
          properties: {
            $schema: {
              ...
              type: 'string',
              format: 'uri',
              examples: ['https://s3d.adobe.io/schemas/restv1beta.RenderSceneRequest.json'],
            },
            autoFraming: {
              ...
              properties: {
                algorithm: {
                  type: 'string',
                  default: 'auto',
                  enum: ['auto', 'bounding_cylinder', 'frustum_fit'],
                },
                zoomFactor: {
                  description:
        ...
        requestBody: {
          ...
          properties: {
            $schema: {
              ...
              type: 'string',
              format: 'uri',
              examples: ['https://s3d.adobe.io/schemas/restv1beta.RenderModelRequest.json'],
            },
            autoFraming: {
