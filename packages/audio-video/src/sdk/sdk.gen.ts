...
class HeyApiRegistry<T> {
    ...
    get(key?: string): T {
        ...
        if (!instance) {
            throw new Error(`No SDK client found. Create one with "new AudioVideoSdk()" to fix this error.`);
        }
        return instance;
    }
...
export class AudioVideoSdk extends HeyApiClient {
    public static readonly __registry = new HeyApiRegistry<AudioVideoSdk>();
    ...
    constructor(args?: {
        ...
        super(args);
        AudioVideoSdk.__registry.set(this, args?.key);
    }
     ...
     */
    public voices<ThrowOnError extends boolean = false>(options?: Options<VoicesData, ThrowOnError>) {
        return (options?.client ?? this.client).get<VoicesResponses, VoicesErrors, ThrowOnError>({
     ...
     */
    public generateSpeech<ThrowOnError extends boolean = false>(options: Options<GenerateSpeechData, ThrowOnError>) {
        return (options.client ?? this.client).post<GenerateSpeechResponses, GenerateSpeechErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }, { name: 'x-api-key', type: 'apiKey' }],
     ...
     */
    public status<ThrowOnError extends boolean = false>(options: Options<StatusData, ThrowOnError>) {
     ...
     */
    public templateDescribe<ThrowOnError extends boolean = false>(options: Options<TemplateDescribeData, ThrowOnError>) {
        return (options.client ?? this.client).post<TemplateDescribeResponses, TemplateDescribeErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }, { name: 'x-api-key', type: 'apiKey' }],
     ...
     */
    public getPresets<ThrowOnError extends boolean = false>(options?: Options<GetPresetsData, ThrowOnError>) {
        return (options?.client ?? this.client).get<GetPresetsResponses, GetPresetsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }, { name: 'x-api-key', type: 'apiKey' }],
            url: '/v1/presets',
            ...options
        });
     ...
     */
    public templateRender<ThrowOnError extends boolean = false>(options: Options<TemplateRenderData, ThrowOnError>) {
        return (options.client ?? this.client).post<TemplateRenderResponses, TemplateRenderErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }, { name: 'x-api-key', type: 'apiKey' }],
     ...
     */
    public cancelRenderJob<ThrowOnError extends boolean = false>(options: Options<CancelRenderJobData, ThrowOnError>) {
        return (options.client ?? this.client).put<CancelRenderJobResponses, CancelRenderJobErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }, { name: 'x-api-key', type: 'apiKey' }],
            url: '/v1/cancel/{jobId}',
            ...options
        });
     ...
     */
    public listRenderJobs<ThrowOnError extends boolean = false>(options?: Options<ListRenderJobsData, ThrowOnError>) {
        return (options?.client ?? this.client).get<ListRenderJobsResponses, ListRenderJobsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }, { name: 'x-api-key', type: 'apiKey' }],
     ...
     */
    public generateReframedVideo<ThrowOnError extends boolean = false>(options: Options<GenerateReframedVideoData, ThrowOnError>) {
        return (options.client ?? this.client).post<GenerateReframedVideoResponses, GenerateReframedVideoErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }, { name: 'x-api-key', type: 'apiKey' }],
            url: '/v1/reframe',
            ...options,
            headers: {
     ...
     */
    public transcribe<ThrowOnError extends boolean = false>(options: Options<TranscribeData, ThrowOnError>) {
     ...
     */
    public dub<ThrowOnError extends boolean = false>(options: Options<DubData, ThrowOnError>) {
        return (options.client ?? this.client).post<DubResponses, DubErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }, { name: 'x-api-key', type: 'apiKey' }],
            url: '/v1/dub',
            ...options,
            headers: {
     ...
     */
    public avatars<ThrowOnError extends boolean = false>(options?: Options<AvatarsData, ThrowOnError>) {
        return (options?.client ?? this.client).get<AvatarsResponses, AvatarsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }, { name: 'x-api-key', type: 'apiKey' }],
            url: '/v1/avatars',
            ...options
        });
     ...
     */
    public generateReframedVideoV2<ThrowOnError extends boolean = false>(options: Options<GenerateReframedVideoV2Data, ThrowOnError>) {
        return (options.client ?? this.client).post<GenerateReframedVideoV2Responses, GenerateReframedVideoV2Errors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }, { name: 'x-api-key', type: 'apiKey' }],
            url: '/v2/reframe',
            ...options,
            headers: {
     ...
     */
    public jobResultV2<ThrowOnError extends boolean = false>(options: Options<JobResultV2Data, ThrowOnError>) {
        return (options.client ?? this.client).get<JobResultV2Responses, JobResultV2Errors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }, { name: 'x-api-key', type: 'apiKey' }],
            url: '/v2/status/{jobId}',
            ...options
        });
     ...
     */
    public generateAvatar<ThrowOnError extends boolean = false>(options: Options<GenerateAvatarData, ThrowOnError>) {
        return (options.client ?? this.client).post<GenerateAvatarResponses, GenerateAvatarErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }, { name: 'x-api-key', type: 'apiKey' }],
