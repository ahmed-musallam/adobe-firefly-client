...
export const openapiMcpTools = [
  {
    ...
    inputSchema: {
          ...
          allOf: [
            {
              allOf: [
                              ...
                              properties: {
                                fontsDirectories: {
                                  ...
                                  items: {
                                    type: 'string',
                                    description:
                                      "This provides a path to a directory relative to a temporary base directory (working directory) where the fonts can be found. It cannot go up using '..' or '/'. Should be a valid path. For specifying a working directory, mention '.'.",
                                  },
                                },
                              },
                            },
                            links: {
                              ...
                              properties: {
                                replaceLinks: {
                                  ...
                                  items: {
                                    type: 'object',
                                    required: ['targetDocument', 'mapping'],
                                    properties: {
                                      targetDocument: {
                                        description:
                ...
                {
                  description:
                    'The base job request for any job with the option to specify output URLs.',
                  type: 'object',
                  properties: {
                    outputs: {
                      type: 'array',
            ...
            },
            {
              ...
              properties: {
                params: {
                  type: 'object',
                  required: ['targetDocument', 'dataSource'],
                  properties: {
                    targetDocument: {
                    ...
                    exportSettings: {
                      ...
                      properties: {
                        jobOptionsFile: {
                          ...
                          default: 'PDF preset `High Quality Print` will be used if not provided.',
                        },
                        pdfPreset: {
                          type: 'string',
                          description:
      ...
      required: ['Authorization', 'x-api-key', 'requestBody'],
    },
    method: 'post',
      ...
      properties: {
        ...
        requestBody: {
          allOf: [
            ...
            {
              description:
                'Filters according to which the information related to data merge tags would be retrieved.',
              type: 'object',
              required: ['params'],
              properties: {
                params: {
                  type: 'object',
                  required: ['targetDocument'],
                  properties: {
                    targetDocument: {
  ...
  },
  {
    ...
    inputSchema: {
            ...
            params: {
              ...
              properties: {
                ...
                dataSource: {
                  ...
                  items: {
                    type: 'object',
                    required: ['sourceURI', 'destinationURI'],
                    properties: {
                      sourceURI: {
                        type: 'string',
                        description:
      ...
      required: ['Authorization', 'x-api-key', 'x-aem-token', 'requestBody'],
    },
    method: 'post',
          ...
          allOf: [
            ...
            },
            {
              ...
              properties: {
                params: {
                  type: 'object',
                  required: ['targetDocuments', 'outputMediaType'],
                  properties: {
                    targetDocuments: {
                      description:
                    ...
                    renderingStyle: {
                      ...
                      enum: ['baseline_encoding', 'progressive_encoding'],
                    },
                    resolution: {
                      type: 'integer',
                      default: 72,
                    ...
                    includeInteractiveElements: {
                      ...
                      enum: ['do_not_include', 'appearance_only'],
                    },
                    exportWhichLayers: {
                      type: 'string',
                      description:
  ...
  },
  {
    ...
    inputSchema: {
      ...
      required: ['Authorization', 'x-api-key', 'script_id', 'script_name', 'requestBody'],
    },
    method: 'post',
  ...
  },
  {
    ...
    inputSchema: {
      ...
      required: ['Authorization', 'x-api-key', 'script_name'],
    },
    method: 'get',
  ...
  },
  {
    ...
    inputSchema: {
        ...
        requestBody: {
          ...
          properties: {
            appVersionStrategy: {
              ...
              enum: ['latest_version', 'fixed_major_version', 'fixed_major_and_minor_version'],
            },
            majorAppVersion: {
              type: 'string',
              description:
      ...
      required: ['x-api-key', 'Authorization', 'script_name', 'requestBody'],
    },
    method: 'put',
  ...
  },
  {
    ...
    inputSchema: {
      ...
      required: ['Authorization', 'x-api-key', 'document-info_job_id'],
    },
    method: 'get',
      ...
      properties: {
        ...
        requestBody: {
          allOf: [
            ...
            {
              description: 'Inputs for converting PDF to InDesign document.',
              type: 'object',
              required: ['params'],
              properties: {
                params: {
  ...
  {
    name: 'getConvertPDFToInDesignJobStatus',
    description:
    ...
    inputSchema: {
      ...
      required: ['Authorization', 'x-api-key', 'convert-pdf-to-indesign_job_id'],
    },
    method: 'get',
  ...
  },
  {
    ...
    inputSchema: {
      ...
      required: ['Authorization', 'x-api-key', 'id'],
    },
    method: 'get',
